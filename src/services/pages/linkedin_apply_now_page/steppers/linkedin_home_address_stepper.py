...
class LinkedinHomeAddressStepper:
  ...
  def __handle_street_address(self) -> None:
    ...
    street_address_line_one_input = self.__easy_apply_div.find_element(By.ID, street_address_line_one_input_id)
  ...
  def __handle_city(self) -> None:
    ...
    city_span = self.__selenium_helper.get_element_by_exact_text("City", ElementType.SPAN, self.__easy_apply_div)
    city_label = city_span.find_element(By.XPATH, "..")
    city_input_id = city_label.get_attribute("for")
    city_input = self.__easy_apply_div.find_element(By.ID, city_input_id)
  ...
  def __handle_zip_slash_postal_code(self) -> None:
    ...
    postal_code_input = self.__easy_apply_div.find_element(By.ID, postal_code_input_id)
  ...
  def __handle_state(self) -> None:
    ...
    state_input = self.__easy_apply_div.find_element(By.ID, state_input_id)
